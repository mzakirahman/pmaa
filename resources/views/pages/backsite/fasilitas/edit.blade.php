        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Fasilitas</h3>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.fasilitas.update', [$fasilitas->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="fa fa-edit"></i> Form Fasilitas</h4>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="judul" name="judul"
                                                            class="form-control"
                                                            value="{{ old('judul', isset($fasilitas) ? $fasilitas->judul : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="isi" name="isi"
                                                            class="form-control"
                                                            value="{{ old('isi', isset($fasilitas) ? $fasilitas->isi : '') }}"
                                                            autocomplete="off" required>
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="gambar"
                                                                aria-describedby="gambar">{{ isset($fasilitas->gambar) ? basename($fasilitas->gambar) : 'Pilih Foto' }}</label>
                                                        </div>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.fasilitas.index') }}" style="width:120px;"
                                                ...
                                                <button type="submit" style="width:120px;" class="btn btn-cyan"
                                                    onclick="return confirm('Anda yakin ingin melakukan perubahan pada data Fasilitas ini ?')">
