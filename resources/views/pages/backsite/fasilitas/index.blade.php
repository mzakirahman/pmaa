        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Fasilitas</h3>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.fasilitas.store') }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="judul" name="judul"
                                                                class="form-control" placeholder="Judul Fasilitas"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Fasilitas List</h4>
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        @forelse($fasilitas as $key => $fasilitas_item)
                                                            <tr data-entry-id="{{ $fasilitas_item->id }}">
                                                                <td>{{ $fasilitas_item->judul ?? '' }}</td>
                                                                <td>{{ $fasilitas_item->isi ?? '' }}</td>
                                                                <td><a data-fancybox="gallery"
                                                                        data-src="{{ request()->getSchemeAndHttpHost() . '/storage' . '/' . $fasilitas_item->gambar }}"
                                                                        class="blue accent-4">Lihat</a></td>
                                                                <td class="text-center">
                                                                    @can('fasilitas_show')
                                                                        <a href="#mymodal"
                                                                            data-remote="{{ route('backsite.fasilitas.show', $fasilitas_item->id) }}"
                                                                            data-toggle="modal" data-target="#mymodal"
                                                                            data-title="Fasilitas Detail" class="badge badge-info"
                                                                    ...
                                                                    @endcan
                                                                    @can('fasilitas_edit')
                                                                        <a href="{{ route('backsite.fasilitas.edit', $fasilitas_item->id) }}"
                                                                    ...
                                                                    @can('fasilitas_delete')
                                                                        <a href="#" class="badge badge-danger"
                                                                            ...
                                                                            onclick="deleteFasilitas({{ $fasilitas_item->id }})"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="20"
                                                                                height="20" viewBox="0 0 24 24"
                                                                                style="fill: rgb(255, 255, 255);transform: ;msFilter:;">
                                                                                <path
    ...
    <script>
        ...
        function deleteFasilitas(fasilitasId) {
            if (confirm('Anda yakin ingin menghapus data ini?')) {
                ...
                form.action = '{{ route('backsite.fasilitas.destroy', '__id') }}'.replace('__id', fasilitasId);
                form.method = 'POST';
