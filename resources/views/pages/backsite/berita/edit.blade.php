                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.berita.update', [$berita->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="fa fa-edit"></i> Form Berita</h4>
                                                ...
                                                <div class="form-group row {{ $errors->has('author') ? 'has-error' : '' }}">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="author" id="author" class="form-control select2"
                                                            disabled>
                                                            <option
                                                                value="{{ old('author', isset($berita) ? $berita->author : '') }}"
                                                                disabled selected>{{ $berita->author }}
                                                            </option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="judul" name="judul"
                                                            class="form-control"
                                                            value="{{ old('judul', isset($berita) ? $berita->judul : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="isi" name="isi"
                                                            class="form-control"
                                                            value="{{ old('isi', isset($berita) ? $berita->isi : '') }}"
                                                            autocomplete="off" required>
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="gambar"
                                                                aria-describedby="gambar">{{ isset($berita->gambar) ? basename($berita->gambar) : 'Pilih Foto' }}</label>
                                                        </div>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.berita.index') }}" style="width:120px;"
                                                ...
                                                <button type="submit" style="width:120px;" class="btn btn-cyan"
                                                    onclick="return confirm('Anda yakin ingin melakukan perubahan pada data Berita ini ?')">
