                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.galeri.store') }}"
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="judul" name="judul"
                                                                class="form-control" placeholder="Judul Galeri"
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Galeri List</h4>
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        @forelse($galeri as $key => $galeri_item)
                                                            <tr data-entry-id="{{ $galeri_item->id }}">
                                                                <td>{{ $galeri_item->judul ?? '' }}</td>
                                                                <td>{{ $galeri_item->isi ?? '' }}</td>
                                                                <td><a data-fancybox="gallery"
                                                                        data-src="{{ request()->getSchemeAndHttpHost() . '/storage' . '/' . $galeri_item->gambar }}"
                                                                        class="blue accent-4">Lihat</a></td>
                                                                <td class="text-center">
                                                                    @can('galeri_show')
                                                                        <a href="#mymodal"
                                                                            data-remote="{{ route('backsite.galeri.show', $galeri_item->id) }}"
                                                                            data-toggle="modal" data-target="#mymodal"
                                                                            data-title="Galeri Detail" class="badge badge-info"
                                                                    ...
                                                                    @endcan
                                                                    @can('galeri_edit')
                                                                        <a href="{{ route('backsite.galeri.edit', $galeri_item->id) }}"
                                                                    ...
                                                                    @can('galeri_delete')
                                                                        <a href="#" class="badge badge-danger"
                                                                            ...
                                                                            onclick="deleteGaleri({{ $galeri_item->id }})"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="20"
                                                                                height="20" viewBox="0 0 24 24"
                                                                                style="fill: rgb(255, 255, 255);transform: ;msFilter:;">
                                                                                <path
    ...
    <script>
        ...
        function deleteGaleri(galeriId) {
            if (confirm('Anda yakin ingin menghapus data ini?')) {
                ...
                form.action = '{{ route('backsite.galeri.destroy', '__id') }}'.replace('__id', galeriId);
                form.method = 'POST';
