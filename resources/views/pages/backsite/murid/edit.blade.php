        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Edit Murid</h3>
                                ...
                                <div class="card-content collpase show">
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            action="{{ route('backsite.murid.update', [$murid->id]) }}" method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="fa fa-edit"></i> Form Murid</h4>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="nama" name="nama"
                                                            ...
                                                            value="{{ old('nama', isset($murid) ? $murid->nama : '') }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <select name="jenis_kelamin" id="jenis_kelamin" class="form-control select2"
                                                            required>
                                                            <option
                                                                value="{{ old('jenis_kelamin', isset($murid) ? $murid->jenis_kelamin : '') }}"
                                                                disabled selected>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="nisn" name="nisn"
                                                            class="form-control"
                                                            value="{{ old('nisn', isset($murid) ? $murid->nisn : '') }}"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="nama_wali" name="nama_wali"
                                                            class="form-control"
                                                            value="{{ old('nama_wali', isset($murid) ? $murid->nama_wali : '') }}"
                                                            autocomplete="off" placeholder="example +628xxxxxxxxxx"
                                                            required>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <input type="text" id="kontak" name="kontak"
                                                            class="form-control"
                                                            value="{{ old('kontak', isset($murid) ? $murid->kontak : '') }}"
                                                            autocomplete="off" placeholder="example +628xxxxxxxxxx"
                                                            required>
                                                    ...
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="custom-file">
                                                            ...
                                                            <label class="custom-file-label" for="foto"
                                                                aria-describedby="foto">{{ isset($murid->foto) ? basename($murid->foto) : 'Pilih Foto' }}</label>
                                                        </div>
                                            ...
                                            <div class="form-actions text-right">
                                                <a href="{{ route('backsite.murid.index') }}" style="width:120px;"
