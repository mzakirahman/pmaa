        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Murid</h3>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.murid.store') }}"
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="nisn">NISN <code
                                                                style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="number" id="nisn" name="nisn"
                                                                class="form-control" placeholder="NISN"
                                                                value="{{ old('nisn') }}" autocomplete="off" required>
                                                    ...
                                                    <div class="form-group row">
                                                        <label class="col-md-3 label-control" for="nama_wali">Nama Wali <code
                                                                style="color:red;">required</code></label>
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="text" id="nama_wali" name="nama_wali"
                                                                class="form-control" placeholder="Nama Wali"
                                                                value="{{ old('nama_wali') }}" autocomplete="off" required>

                                                            @if ($errors->has('nama_wali'))
                                                                <p style="font-style: bold; color: red;">
                                                                    {{ $errors->first('nama_wali') }}</p>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-md-9 mx-auto">
                                                            <input type="number" id="kontak" name="kontak"
                                                                ...
                                                                value="{{ old('kontak') }}" autocomplete="off" required>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">Murid List</h4>
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        @forelse($murid as $key => $pengurus_item)
                                                            <tr data-entry-id="{{ $pengurus_item->id }}">
                                                                <td>{{ $pengurus_item->nama ?? '' }}</td>
                                                                <td>{{ $pengurus_item->nisn ?? '' }}</td>
                                                                <td><a data-fancybox="gallery"
                                                                        data-src="{{ request()->getSchemeAndHttpHost() . '/storage' . '/' . $pengurus_item->foto }}"
                                                                        class="blue accent-4">Lihat</a></td>
                                                                <td class="text-center">
                                                                    @can('pengurus_show')
                                                                        <a href="#mymodal"
                                                                            data-remote="{{ route('backsite.murid.show', $pengurus_item->id) }}"
                                                                            data-toggle="modal" data-target="#mymodal"
                                                                            data-title="Murid Detail" class="badge badge-info"
                                                                    ...
                                                                    @endcan
                                                                    @can('pengurus_edit')
                                                                        <a href="{{ route('backsite.murid.edit', $pengurus_item->id) }}"
                                                                    ...
                                                                    @can('pengurus_delete')
                                                                        <a href="#" class="badge badge-danger"
                                                                            ...
                                                                            onclick="deletePengurus({{ $pengurus_item->id }})"><svg
                                                                                xmlns="http://www.w3.org/2000/svg" width="20"
                                                                                height="20" viewBox="0 0 24 24"
                                                                                style="fill: rgb(255, 255, 255);transform: ;msFilter:;">
                                                                                <path
...
@push('after-script')
    ...
    <script>
        ...
        function deletePengurus(pengurusId) {
            if (confirm('Anda yakin ingin menghapus murid ini?')) {
                var form = document.createElement('form');
                form.action = '{{ route('backsite.murid.destroy', '__id') }}'.replace('__id', pengurusId);
                form.method = 'POST';
