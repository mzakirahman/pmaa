        ...
        <div class="content-wrapper">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Pengurus</h3>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content collapse hide">
                                        <div class="card-body card-dashboard">
                                            ...
                                            <form class="form form-horizontal" action="{{ route('backsite.pengurus.store') }}"
                                        ...
                                        <div class="card-body card-dashboard">
                                            ...
                                            <div class="table-responsive">
                                                <table
                                                    ...
                                                    <tbody>
                                                        @forelse($pengurus as $key => $pengurus_item)
                                                            <tr data-entry-id="{{ $pengurus_item->id }}">
                                                                <td>{{ $pengurus_item->nama ?? '' }}</td>
                                                                <td>{{ $pengurus_item->jabatan->nama ?? '' }}</td>
                                                                <td>{{ $pengurus_item->kontak ?? '' }}</td>
                                                                ...
                                                                <td class="text-center">
                                                                    @can('pengurus_show')
                                                                        <a href="#mymodal"
                                                                            data-remote="{{ route('backsite.pengurus.show', $pengurus_item->id) }}"
                                                                            data-toggle="modal" data-target="#mymodal"
                                                                            data-title="Pengurus Detail" class="badge badge-info"
                                                                    ...
                                                                    @endcan
                                                                    @can('pengurus_edit')
                                                                        <a href="{{ route('backsite.pengurus.edit', $pengurus_item->id) }}"
    ...
    <script>
        ...
        function deletePengurus(pengurusId) {
            if (confirm('Anda yakin ingin menghapus pengurus ini?')) {
                ...
                form.action = '{{ route('backsite.pengurus.destroy', '__id') }}'.replace('__id', pengurusId);
                form.method = 'POST';
